...
def home(request):
    ...
    return render(request, 'base/home.html', context={'rooms':rooms, 'topics':topics, 'room_message': room_message,'room_count':room_count})
...
def userProfile(request,pk):
     ...
     room_message= user.message_set.all().order_by('-created_at')
     room_count=room.count()
     context = {'user':user,'rooms':room,'topics':topic,'room_message':room_message,'room_count':room_count}
